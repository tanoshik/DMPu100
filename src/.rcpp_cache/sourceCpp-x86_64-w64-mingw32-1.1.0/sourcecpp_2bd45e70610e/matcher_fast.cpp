...
// compute_scores_uint16
IntegerVector compute_scores_uint16(IntegerVector q1, IntegerVector q2, IntegerVector r1, IntegerVector r2, int any_code);
RcppExport SEXP sourceCpp_1_compute_scores_uint16(SEXP q1SEXP, SEXP q2SEXP, SEXP r1SEXP, SEXP r2SEXP, SEXP any_codeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type q1(q1SEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type q2(q2SEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type r1(r1SEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type r2(r2SEXP);
    Rcpp::traits::input_parameter< int >::type any_code(any_codeSEXP);
    rcpp_result_gen = Rcpp::wrap(compute_scores_uint16(q1, q2, r1, r2, any_code));
